...
function constructElement(todo) {
  return "<li><p>".concat(todo.title, "</p><p>").concat(todo.body, "</p></li>");
}

function createTodo(title, body) {
  // Construct a todo
  var todo = constructTodo(title, body);
  if (!todo) return null; // Inject element to DOM

  var todoListItem = constructElement(todo);
  return todoListItem;
}

module.exports = {
  constructTodo: constructTodo,
  constructElement: constructElement,
  createTodo: createTodo
};
},{}],"app.js":[function(require,module,exports) {
var _require = require("./utils"),
    createTodo = _require.createTodo; // Variables
...
createForm.addEventListener("submit", function (e) {
  ...
  var todoListItem = createTodo(title.value, body.value);
